...
function generateFields() {
    ...
    for (let i = 0; i < elementNb; i++) {
        ...
        stemInfoIcon.appendChild(stemTooltipText);
          ...
          // Append all
          container.appendChild(syntacticFormLabel);
          container.appendChild(syntacticFormInput);
          container.appendChild(addSyntacticFormBtn);
          container.appendChild(selectedSyntacticFormDiv);
          container.appendChild(hiddenSyntacticFormInput);
          container.appendChild(document.createElement('br'));
