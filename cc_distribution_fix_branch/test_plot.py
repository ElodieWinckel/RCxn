#!/usr/bin/env python3
"""Simple test script to generate CC distribution plot"""
...
def main():
    ...
    plt.savefig('17_cc_distribution_fixed.png', dpi=300, bbox_inches='tight')
    print('Saved 17_cc_distribution_fixed.png')
